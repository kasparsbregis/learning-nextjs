      ...
      <>
        <div
          className={cn(
            ...
            /* Selected */
            "bg-foreground/40 group-data-[selected]:bg-primary",
            /* Readonly */
        ...
        >
          <div
            className={cn(
              "pointer-events-none block size-5 rounded-full bg-yellow-500 group-data-[selected]:bg-yellow-300 shadow-lg ring-0 transition-transform",
              /* Selected */
